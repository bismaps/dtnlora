"""
Dummy module for micropython. Not at all CPython compliant. Just suppresses import error.

Useful if type hints are used and micropython should just ignore them.

copied from the pycopy project: https://github.com/pfalcon/pycopy-lib/blob/master/typing/typing.py
"""
